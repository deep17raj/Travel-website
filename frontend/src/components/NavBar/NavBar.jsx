...
function NavBar() {
    ...
    const location = useLocation(); // Optional: to check active route
        ...
        <header className="w-full mt-4">
            <nav className="w-[90%] md:w-3/4 mx-auto flex items-center justify-between py-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden lg:block">
                        <Link to="/requestGuide">
                            <button className="bg-[#166EF3] hover:bg-blue-700 transition-colors text-white rounded-full px-5 py-2.5 flex items-center gap-2 shadow-lg shadow-blue-200 cursor-pointer">
            ...
            <div className={`lg:hidden absolute left-0 w-full bg-white shadow-xl z-50 transition-all duration-300 ease-in-out overflow-hidden ${open ? "max-h-96 opacity-100 top-20" : "max-h-0 opacity-0 top-20"}`}>
                <div className="flex flex-col w-[90%] mx-auto py-6 gap-4">
                    ...
                    <Link to="/requestGuide" onClick={() => setOpen(false)}>
                        <button className="w-full bg-[#166EF3] text-white rounded-full p-3 flex justify-center items-center gap-2 mt-2">
